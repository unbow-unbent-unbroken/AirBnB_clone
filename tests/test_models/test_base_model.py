...
class TestBaseModelInit(unittest.TestCase):
    def test_obj_type(self):
        """Verify that the object is an instance of BaseModel."""
        obj = BaseModel()
    ...
    def test_multiple_instances(self):
        ...
        self.assertEqual(bm1.name, "Object1")
        self.assertEqual(bm2.name, "Object2")
    ...
    def test_updated_different_time(self):
        """Verify that 'updated_at' times are
            different after saving
    ...
    def test_print_class(self):
        ...
        self.assertIn("BaseModel", printed_output)
    ...
    def test_to_dict_method(self):
        ...
        instance = BaseModel()
        instance.name = "godie"
        instance.created_at = datetime(2024, 2, 11, 12, 34, 56)
        instance.updated_at = datetime(2024, 2, 11, 12, 45, 0)
